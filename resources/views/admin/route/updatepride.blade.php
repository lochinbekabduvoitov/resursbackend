  ...
  <body>
    ...
    <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
      ...
      <div class="container-fluid page-body-wrapper">
       ...
       <form action="{{url('/updatedpride', $data->id)}}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="form-group">
        <input style="color:blue" type="text" name="name" placeholder="User name"value="{{$data->name}}" required >
      </div>
      <div class="form-group">
        <input style="color:blue"  type="text"  name="description" placeholder="Description" value="{{$data->description}}" required >
      </div>
      <div class="form-group">
      <img  height="200" width="200" src="/Prideimages/{{$data->image}}" alt="">
      </div>
      <div class="form-group">
